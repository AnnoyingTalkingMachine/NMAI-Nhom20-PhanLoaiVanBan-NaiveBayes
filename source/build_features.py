...
# Cắt nhỏ kích thước dữ liệu đưa vào xử lý
...
trim_index = int(len(final_data) * 1) #0.8
...
# for key in train_data[1][0]:
#     print(key)
#     print(train_data[1][0][key])
