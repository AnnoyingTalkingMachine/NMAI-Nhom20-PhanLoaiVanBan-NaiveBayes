...
dataFrame_positive = dataFrame_positive.iloc[:1000] # :int(len(dataFrame_positive) / 40)
dataFrame_negative = dataFrame_negative.iloc[:1000] # :int(len(dataFrame_negative) / 40)
